## helm-s3-publisher completion powershell
...
To load completions in your current shell session:
	...
	helm-s3-publisher completion powershell | Out-String | Invoke-Expression
...
```
helm-s3-publisher completion powershell [flags]
```
